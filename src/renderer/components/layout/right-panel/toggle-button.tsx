  ...
  return (
    <div className="fixed z-(--z-panel-toggle) flex items-center gap-2 top-2.75 right-3.25">
      {onTerminalToggle && (
        <Button
          ...
          className={` p-1.25! transition-all duration-300 ease-out
             rounded-lg cursor-pointer text-primary-700 dark:text-primary-300 hover:bg-primary-100/80 dark:hover:bg-primary/20
            ${
            terminalOpen
      ...
      <Button
        ...
        tooltipPosition="left"
        onClick={onClick}
        className="rounded-lg cursor-pointer hover:bg-primary-100/80 dark:hover:bg-primary/20 p-1! text-primary-700 dark:text-primary-300! transition-all duration-300 ease-out"
