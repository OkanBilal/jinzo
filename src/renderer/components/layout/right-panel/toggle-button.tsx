...
export function ToggleButton({ isOpen, onClick }: ToggleButtonProps) {
  return (
    <Button
      ...
      onClick={onClick}
      className="fixed z-60 rounded-full! p-1.5! text-primary-900 dark:text-primary-300! bg-primary-100/30 dark:bg-primary/5 transition-all duration-300 ease-out top-3 right-3"
