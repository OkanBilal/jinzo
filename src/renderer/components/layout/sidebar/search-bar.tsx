...
export default function SearchBar({
    ...
    return (
        <div
            className={`relative transition-all duration-200 ease-in-out h-9 flex items-center ${isExpanded ? "flex-1" : "w-auto"
                }`}
            ...
            {isExpanded ? (
                <div className="relative animate-in fade-in duration-200 w-full">
                    ...
                    <input
                        ...
                        rounded-[10px] pl-10 pr-10 text-sm text-primary-900 dark:text-primary-100 
                ...
                <button
                    onClick={onToggle}
                    className="h-9 w-9 cursor-pointer flex items-center justify-center hover:bg-primary-950/5 dark:hover:bg-primary/10 rounded-lg transition-colors"
                >
