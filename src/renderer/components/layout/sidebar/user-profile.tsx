...
export default function UserProfile({ avatarUrl, displayName, isVisible }: UserProfileProps) {
    return (
        <div
            className={`flex items-center gap-3 transition-all duration-300 ease-in-out ${isVisible
