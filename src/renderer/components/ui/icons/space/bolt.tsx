...
interface BoltProps extends SVGProps<SVGSVGElement> {
  animated?: boolean
}

const SvgComponent = ({ animated, ...props }: BoltProps) => (
  <svg
  ...
  >
    {animated && (
      <style>{`
        @keyframes flicker1 {
          ...
          25%  { transform: translate(-0.3px, 1.2px) scale(0.85, 1.1); opacity: 0.7; }
          50%  { transform: translate(0.2px, 0.4px) scale(1.05, 0.85); opacity: 0.9; }
          75%  { transform: translate(-0.1px, 1.5px) scale(0.9, 1.15); opacity: 0.55; }
          100% { transform: translate(0, 0) scale(1); opacity: 0.95; }
        }
        @keyframes flicker2 {
          0%   { transform: translate(0, 0) scale(1); opacity: 0.8; }
          30%  { transform: translate(0.4px, 1px) scale(1.1, 0.8); opacity: 0.6; }
          60%  { transform: translate(-0.2px, 1.8px) scale(0.8, 1.2); opacity: 0.9; }
          100% { transform: translate(0, 0) scale(1); opacity: 0.8; }
        }
        @keyframes flicker3 {
          0%   { transform: translate(0, 0) scale(1); opacity: 0.7; }
          20%  { transform: translate(0.3px, 0.8px) scale(0.9, 1.15); opacity: 0.5; }
          45%  { transform: translate(-0.4px, 1.6px) scale(1.1, 0.75); opacity: 0.85; }
          70%  { transform: translate(0.1px, 2px) scale(0.85, 1.05); opacity: 0.4; }
          100% { transform: translate(0, 0) scale(1); opacity: 0.7; }
        }
        @keyframes flicker4 {
          0%   { transform: translate(0, 0) scale(1); opacity: 0.6; }
          35%  { transform: translate(-0.2px, 1.4px) scale(1.15, 0.85); opacity: 0.85; }
          65%  { transform: translate(0.3px, 0.6px) scale(0.8, 1.1); opacity: 0.5; }
          100% { transform: translate(0, 0) scale(1); opacity: 0.6; }
        }
        .fl1 { animation: flicker1 0.3s ease-in-out infinite; transform-origin: 1.2px 20.5px; }
        .fl2 { animation: flicker2 0.35s ease-in-out infinite 0.08s; transform-origin: 3.8px 21px; }
        .fl3 { animation: flicker3 0.4s ease-in-out infinite 0.15s; transform-origin: 2.5px 21.5px; }
        .fl4 { animation: flicker4 0.28s ease-in-out infinite 0.05s; transform-origin: 0.5px 21.8px; }
      `}</style>
    )}
    <path
      fill="currentColor"
    ...
    {animated && (
      <g>
        ...
        <path
          className="fl1"
          d="M1.2 20.5 C1.2 19, 2.4 17.5, 2.4 17.5 C2.4 17.5, 3.6 19, 3.6 20.5 C3.6 21.8, 2.6 22.5, 2.4 22.5 C2.2 22.5, 1.2 21.8, 1.2 20.5Z"
          fill="currentColor"
          opacity="0.9"
        />
        {/* Right flame */}
        <path
          className="fl2"
          d="M3.2 21 C3.2 19.8, 4 18.8, 4 18.8 C4 18.8, 4.8 19.8, 4.8 21 C4.8 22, 4.1 22.6, 4 22.6 C3.9 22.6, 3.2 22, 3.2 21Z"
          fill="currentColor"
          opacity="0.75"
        />
        {/* Left small flame */}
        <path
          className="fl3"
          d="M-0.2 21.5 C-0.2 20.5, 0.4 19.5, 0.4 19.5 C0.4 19.5, 1 20.5, 1 21.5 C1 22.3, 0.5 22.8, 0.4 22.8 C0.3 22.8, -0.2 22.3, -0.2 21.5Z"
          fill="currentColor"
          opacity="0.6"
        />
        {/* Tiny spark */}
        <path
          className="fl4"
          d="M2 22.2 C2 21.6, 2.4 21, 2.4 21 C2.4 21, 2.8 21.6, 2.8 22.2 C2.8 22.7, 2.5 23, 2.4 23 C2.3 23, 2 22.7, 2 22.2Z"
          fill="currentColor"
          opacity="0.5"
        />
      </g>
