...
const baseInputClasses =
	"w-full rounded-xl border min-w-60 border-primary-200/70 dark:border-primary-800 bg-white/80 dark:bg-primary-950/40 px-3 py-2 text-sm text-primary-900 dark:text-primary-100  placeholder:text-primary-400/80 dark:placeholder:text-primary-500 focus:outline-none transition disabled:opacity-60 disabled:cursor-not-allowed";
