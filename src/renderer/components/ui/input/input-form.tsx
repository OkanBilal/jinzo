    ...
    return (
      ...
      >
        <textarea
          ...
          className="rounded-3xl w-full pl-6 pr-20 py-4 placeholder:text-[15px] outline-none resize-none overflow-hidden dark:text-primary-200 text-primary-700 placeholder:text-primary-500 dark:placeholder:text-primary-600"
        />
