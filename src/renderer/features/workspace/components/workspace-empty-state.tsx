  ...
  if (presentation === "headline") {
    ...
    return (
      <div className="flex flex-col items-center py-2 text-center shrink-0 w-full max-w-210">
        ...
        >
          <Mains
            className="h-16 w-auto shrink-0 text-primary-400 dark:text-primary-600 hover:text-primary-700 dark:hover:text-primary-300 hover:scale-102 transition-all duration-300"
            aria-hidden
          />
        </Button>
