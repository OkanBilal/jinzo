      ...
      >
        {[
          ...
          <Button
            ...
            onClick={onClick}
            role="menuitem"
            className="flex w-full text-left text-sm first:rounded-t-xl last:rounded-b-xl items-center px-2.5 py-2.5 hover:bg-copilot-lightblue dark:hover:bg-primary-600/20 text-primary-700 dark:text-primary-100 cursor-pointer"
          >
